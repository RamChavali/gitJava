...
public class addPayCard_additionalCard {
	...
	@Test
	public addPayCard_additionalCard() throws Exception
	{
		// setup
		...
		manageCardsPage.addAdditionalPaymentCard();
		manageCardsPage.enterAdditionalBillingAddr();
