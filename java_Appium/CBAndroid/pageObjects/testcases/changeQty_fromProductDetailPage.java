...
public class changeQty_fromProductDetailPage {
	...
	@Test
	public changeQty_fromProductDetailPage() throws Exception
	{
		this.setUp();
		...
		//--------------------------------------------->> implement method overload
		storesPage.changeQtyFromProductDetailPage();
		this.tearDown();
