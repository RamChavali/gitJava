...
public class validLogin_afterLogoutDiffAcct {
	...
	@Test
	public validLogin_afterLogoutDiffAcct() throws Exception
	{
		this.setUp();
		...
		loginPage.signinUsingValidCredentials2(); // logging in with different credentials
		this.tearDown();
	}
