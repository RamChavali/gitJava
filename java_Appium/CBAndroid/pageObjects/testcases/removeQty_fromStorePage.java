...
public class removeQty_fromStorePage {
	...
	@Test
	public removeQty_fromStorePage() throws Exception
	{
		this.setUp();
		...
		//------------------------------------>> same as addToCart_fromStorePage (need to "overload" for DRY)
		storesPage.removeWithPlusIcon();
