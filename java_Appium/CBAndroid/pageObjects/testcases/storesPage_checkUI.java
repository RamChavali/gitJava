...
public class storesPage_checkUI {
	...
	@Test
	public storesPage_checkUI() throws Exception
	{
		this.setUp();
		AndroidDriver driver = new AndroidDriver(new URL ("http://127.0.0.1:4723/wd/hub"), cap);
		StoresPage storesPage = new StoresPage(driver);
		storesPage.navToStoresPage();
		storesPage.checkForStoreHeaderSectionUI();
		storesPage.checkForStoreFrameSectionUI();
		storesPage.checkForNavigationToAndBack();
		this.tearDown();
